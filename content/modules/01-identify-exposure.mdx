...
tldr: "Check home, office, and car for mold. Look for water damage, musty smells, and visible growth. Test with ERMI if unsure. Leave or remediate immediately - you cannot heal while exposed."
readingTime: 8
---
...
import { ExposureInspectionDiagram } from '@/components/modules/visual-diagrams'
...
<div className="bg-blue-50 p-4 rounded-lg mb-6 border-l-4 border-blue-500">
  ...
  <p className="text-blue-800">
    Systematically check every environment you frequent - home, office, car. Look for water damage, musty smells, visible mold. Pay special attention to bathrooms, basements, HVAC systems. Test with ERMI if suspicious. You must leave or properly remediate - no detox protocol works while you're still exposed.
  </p>
</div>

## The First Step to Healing: Finding Your Exposure

<ExposureInspectionDiagram />
...
<SafetyFlag 
  type="critical"
  message="Living or working in a moldy environment can prevent healing, even if you're following perfect detox protocols. You must address exposure before starting any detox."
/>
...
<ChecklistComponent title="Quick Actions You Can Take Today (Under $50)" items={[
  "Buy N95 masks to wear in moldy areas ($20-30)",
  "Get moisture meter to check walls ($15-25)",
  "Purchase mold test plates from Amazon ($30)",
  "Install humidity monitors in each room ($20)",
  "Buy DampRid for problem areas ($10)",
  "Get HEPA vacuum bags if you have compatible vacuum ($20)",
  "Download free mold inspection apps for documentation",
  "Take photos of all suspected mold for records",
  "Create plastic barriers with sheets and tape ($10)",
  "Start a symptom diary (free)"
]} />

<DoThisNow 
  title="Start These Today"
  action="Even if you can't afford professional remediation yet, these low-cost actions can significantly reduce your exposure while you plan next steps."
  urgency="high"
...
<div className="my-6">
  <ToolPreview
    ...
    description="Interactive room-by-room assessment to systematically identify all mold sources"
