...
const modules = [
  ...
  {
    id: '02-exposure-assessment',
    title: 'Exposure Assessment & Remediation',
    description: 'Learn to identify, test for, and safely remediate mold in your environment',
    moduleNumber: 2,
    duration: '60 minutes',
  ...
  },
  {
    ...
    title: 'Opening Drainage Pathways',
  ...
  {
    id: '04-binder-protocols',
    title: 'Binder Protocols',
  ...
  {
    id: '05-diet-nutrition',
    title: 'Anti-Mold Diet & Nutrition',
    description: 'Optimize your diet to reduce inflammation and support detoxification',
    moduleNumber: 5,
    duration: '40 minutes',
    difficulty: 'beginner',
    category: 'lifestyle',
